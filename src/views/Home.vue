<template>
  <header
    class="w-full px-4 py-8 lg:py-12 mx-auto flex items-center gap-4 sticky top-0 z-10 bg-neutral-100 dark:bg-neutral-800 bg-opacity-90 dark:bg-opacity-90 backdrop-filter backdrop-blur"
  >
    <Logo class="logo" />
